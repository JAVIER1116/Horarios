            ...
            <div class="full-box page-header">
                <h3 class="text-center">
                    <i class="fas fa-building fa-fw"></i> &nbsp; <strong>INFORMACÓN DE LA INSTITUCIÓN EDUCATIVA</strong>
                </h3>
                <p class="text-justify">
                    Esta sección se aplica a los datos informativos presentando acciones para informar de una manera más clara los datos personales o académicos de la Institución Educativa "San Miguel".
                </p>
            </div>
            ...
            <div class="container-fluid">
                <form action="" class="form-neon" autocomplete="off">
                    <fieldset>
                        <legend><i class="far fa-building"></i> &nbsp; Información de la Institución</legend>
                        <div class="container-fluid">
                            <div class="row">
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        <label for="empresa_nombre" class="bmd-label-floating">Nombre del Representante (Director)</label>
                                        <input type="text" pattern="[a-zA-z0-9áéíóúÁÉÍÓÚñÑ. ]{1,70}" class="form-control" name="empresa_nombre_reg" id="empresa_nombre" maxlength="70">
                                    </div>
                                </div>
            ...
            <div class="container-fluid">
                <form action="" class="form-neon" autocomplete="off">
                    <fieldset>
                        <legend><i class="far fa-building"></i> &nbsp;Actualizar Información de la Institución</legend>
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
